		...
		<div class="cover-image" style="background-image : url('${pageContext.request.contextPath}/images/bgimg.jpg')"></div>
			<div class="container" id="content">
				...
				<div class="col-xs-12 col-md-6">
					<a href="http://www.ihd.or.kr/guidewim.do"><p class="con2">무선인터넷관리사</p></a>
					<hr>
					<p class="con1">&emsp;&ensp;무선인터넷 홈페이지의 기획, 설계, 개발 및 관리능력, 무선 솔루션 및 무선 Web Programming 개발 능력을 검정하는 자격 <br>
					
					도입목적 및 필요성<br>
					무선인터넷의 이용 확산 및 무선인터넷 산업의 활성화 촉진 <br> 
					무선인터넷 전문인력의 양성·공급 및 기업체의 채용기준으로 활용 <br> 
					무선인터넷의 이해 및 활용능력에 대한 객관적인 평가기준 제시 </p>
				</div>
				<br>
			</div>
	</div>
