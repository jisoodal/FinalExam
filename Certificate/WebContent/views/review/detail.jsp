		...
		<div class="cover-image" style="background-image : url('${pageContext.request.contextPath}/images/bgimg.jpg')"></div>
			<div class="container" id="content">
				...
				<div class="col-xs-12 col-md-12">
					<table class="table table-condensed">
						...
						<tbody>
							...
							<tr>
								<td colspan="2">
									<p>${reviewVo.nb_content}</p>
								</td>
							</tr>
							<tr>
								<td class="text-center" colspan="2">
									<p>
										<c:if test="${!empty reviewVo.nb_filename}">
											<img src="../upload/${reviewVo.nb_filename}" class="detail-img">
										</c:if>
									</p>
								</td>
							</tr>
				...
				<div class="col-xs-12 text-center">
					<input type="button" class="btn btn-info" value="수정" onclick="location.href='updateForm.do?nb_num=${reviewVo.nb_num}'"
						<c:if test="${user_id!=reviewVo.mem_id}"> 
							disabled="disabled" 
						</c:if>>
					<input type="button" class="btn btn-warning" value="삭제" onclick="location.href='delete01.do?nb_num=${reviewVo.nb_num}'"
						<c:if test="${user_id!=reviewVo.mem_id} && ${mem_level==1}"> 
							disabled="disabled" 
						</c:if>>
