		...
		<div class="container" id="content">
			...
			<form action="deleteUser.do" method="post" id="delete_form">
				...
				<div class="form-group col-md-10">
					<label for="mem_id">아이디</label> <b>${user_id}</b>
				</div>

				<div class="form-group col-md-10">
					<label for="mem_pw">비밀번호</label> <input type="password"
						class="form-control" name="mem_pw" id="mem_pw">
				</div>

				<div class="form-group col-md-10">
					<label for="check_pw">비밀번호 확인</label> <input type="password"
						name="check_pw" id="check_pw" class="form-control">
				</div>

				<div class="col-xs-10 text-center">
					<input type="submit" value="회원탈퇴" class="btn btn-info"> <input
